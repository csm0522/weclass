...
<div id ="head">
    ...
    <div class="headm">
    <ul>
    <a href="<?php echo U('login/index');?>"><li style="background:#fa243d;color:white;">登录</li></a>
    ...
    <div class="information" style ="margin-top:30px;"><span>输入账号</span><input type="text" name="" value=""></div>
    <div class="information"><span>输入密码</span><input type="password" name="" value=""></div>

    <div class="footl"><input type="submit" name="" value="登录"></div>
    </div>
    </body>
</html>