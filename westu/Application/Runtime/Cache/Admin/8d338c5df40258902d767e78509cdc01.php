	...
	<table class="table table-bordered">
		...
		<tbody>
			<?php if(is_array($list)): foreach($list as $k=>$C): ?><tr>
					...
					<td>
						<?php if($C['status'] == 1 ): ?><label class="btn btn-primary" type="button" style="background: black;color:white;width: 82px;">已删除</label>
							...
							<?php elseif($C['status'] == 0 ): ?> <a href="/westu/index.php/Admin/Works/deleWorks/id/<?php echo ($C["cid"]); ?>" class="primary" ><button class="btn btn-danger" type="button">删除该课程</button></a><?php endif; ?>
					</td>
